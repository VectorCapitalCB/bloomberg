 ...
 * If a file path is provided via the "simulador.prices.file" property it is
 * read from the filesystem; otherwise the bundled /simulator-prices.json
 * classpath resource is used.
 */
@Slf4j
    ...
    public static Map<String, SimulatorPriceRef> load(String filePath) {
        ...
        try {
            ...
            if (filePath != null && !filePath.isBlank()) {
                ...
                log.info("simulator loading prices from classpath resource /simulator-prices.json");
